...
const REASON_TEXT = {
  ...
  risky_domain: 'Малоизвестный или недавно созданный домен (дешёвая доменная зона, «случайное» имя) запрашивает пароль либо данные карты — частый признак одноразового фишингового сайта.',
  insecure_form: 'Пароль или данные карты запрашиваются по незащищённому http-соединению или на голом IP-адресе. Легитимные страницы входа и оплаты всегда работают по https на нормальном домене.',
