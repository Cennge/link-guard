...
const PAGE_MSG = {
  ...
  risky_domain:
    'Малоизвестный/недавно созданный домен запрашивает пароль или данные карты. Будьте осторожны — так часто выглядят одноразовые фишинговые сайты.',
  insecure_form:
    'Страница запрашивает пароль или данные карты по незащищённому соединению (http) или на голом IP-адресе. Настоящие страницы входа и оплаты используют https и нормальный домен.',
}
